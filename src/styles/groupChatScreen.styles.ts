...
export const styles = StyleSheet.create({
  ...
  listingRow: { flexDirection: 'row', padding: 12, gap: 10, alignItems: 'center' },
  listingThumb: {
    width: 72,
    height: 72,
    borderRadius: 10,
  ...
  listingPrice: { fontSize: 14, fontWeight: '800', color: '#4A6CF7' },
  listingMeta: { fontSize: 11, color: '#888' },
  shareTime: {
    fontSize: 10,
    color: '#aaa',
    paddingHorizontal: 12,
